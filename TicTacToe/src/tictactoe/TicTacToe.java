...
public class TicTacToe {
    ...
    /**
     * Desde el main cridem tots els metodes que s'executaran per fer les tirades al joc
     ...
     * @param taulerJoc inicialitza el array de numeros enters
     */
     ...
     * @param taulerJoc declara el llarg i alt de les files i columnes
     */
    ...
    /**
     * @param i es el inicialitzador 
     * @return retorna O si es una tirada de la maquina || X si es una tirada del jugador
     */
    ...
    /**
     * @param taulerJoc es el nom del array. representa les caselles del tauler de joc de la maquina
     */
    ...
    /**
     * @param taulerJoc es el nom del array.representa les caselles del tauler de joc per al Jugador
     */
    ...
    /**
     * @param taulerJoc representa les caselles del tauler de joc
